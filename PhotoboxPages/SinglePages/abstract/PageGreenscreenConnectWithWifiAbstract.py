...
class PageGreenscreenConnectWithWifiAbstract(Page):
    def __init__(self, pages : AllPages, windowsize:QSize, globalVariable:GlobalPagesVariableService):
        ...
        #Titel
        self.title = self.getTitleAsQLabel(TextKey.PAGE_GREENSCREEN_CONNECT_WIFI_TITLE)
        ...
        #Requirements
        requirementDescription = QLabel(textValue[TextKey.PAGE_GREENSCREEN_CONNECT_WIFI_REQUIREMENT])
        mainContentLayout.addWidget(requirementDescription)

        #Step1
        step1Description = QLabel(textValue[TextKey.PAGE_GREENSCREEN_CONNECT_WIFI_STEP1])
        ...
        #Step2
        step2Description = QLabel(textValue[TextKey.PAGE_GREENSCREEN_CONNECT_WIFI_STEP2])
        mainContentLayout.addWidget(step2Description)

        #Step3
        step3Description = QLabel(textValue[TextKey.PAGE_GREENSCREEN_CONNECT_WIFI_STEP3])
        mainContentLayout.addWidget(step3Description)

        #Step4
        step4Description = QLabel(textValue[TextKey.PAGE_GREENSCREEN_CONNECT_WIFI_STEP4])
        mainContentLayout.addWidget(step4Description)

        #Step5
        step5Description = QLabel(textValue[TextKey.PAGE_GREENSCREEN_CONNECT_WIFI_STEP5])
        mainContentLayout.addWidget(step5Description)


        #Step5
        step6Description = QLabel(textValue[TextKey.PAGE_GREENSCREEN_CONNECT_WIFI_STEP6])
        mainContentLayout.addWidget(step6Description)

        #Navigation#####################################################################################################
        navigationLayout=QHBoxLayout()
        mainLayout.addLayout(navigationLayout)

        backButton = QPushButton(textValue[TextKey.PAGE_GREENSCREEN_CONNECT_WIFI_BACK_BUTTON])
