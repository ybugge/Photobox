...
class CfgKey(enum.Enum):
    ...
    GREENSCREEN_MIN_HSV_COLOR_WITHOUT_TOLERANCE = 7002
    GREENSCREEN_MAX_HSV_COLOR_WITHOUT_TOLERANCE = 7003
    GREENSCREEN_AVERAGE_HSV_COLOR_WITHOUT_TOLERANCE = 7004
    GREENSCREEN_COLOR_HUE_TOLERANCE = 7005
    GREENSCREEN_COLOR_SATURATION_TOLERANCE = 7006
    GREENSCREEN_COLOR_BRIGHTNESS_TOLERANCE = 7007

    #zurück / Neues Foto / Übernhmen / Toleranzen
...
cfgValue[CfgKey.GREENSCREEN_MIN_HSV_COLOR_WITHOUT_TOLERANCE] = "0;0;0"
cfgValue[CfgKey.GREENSCREEN_MAX_HSV_COLOR_WITHOUT_TOLERANCE] = "0;0;0"
cfgValue[CfgKey.GREENSCREEN_AVERAGE_HSV_COLOR_WITHOUT_TOLERANCE] = "0;0;0"
cfgValue[CfgKey.GREENSCREEN_COLOR_HUE_TOLERANCE] = 2
cfgValue[CfgKey.GREENSCREEN_COLOR_SATURATION_TOLERANCE] = 2
cfgValue[CfgKey.GREENSCREEN_COLOR_BRIGHTNESS_TOLERANCE] = 2
