...
class CfgKey(enum.Enum):
    ...
    PI_CAMERA_STATIC_BRIGHTNESS_AWB_GAINS = 19
...
cfgValue[CfgKey.PI_CAMERA_STATIC_BRIGHTNESS_AWB_GAINS] = (2.5, 2.5)
...
class TextKey(enum.Enum):
    ...
    PAGE_CONFIG_CAMERA_AUTO_BRIGHTNESS=1051
...
textValue[TextKey.PAGE_CONFIG_CAMERA_AUTO_BRIGHTNESS] = "Autohelligkeit:"
