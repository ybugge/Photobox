...
#PrintService
textValue[TextKey.PRINT_SERVICE_PRINTER_READY]= "<span style='background-color=transparent;'>Bereit</span>"
textValue[TextKey.PRINT_SERVICE_ERROR]= "<span style='background-color=red;'>Unbekannter Fehler!</span>"
textValue[TextKey.PRINT_SERVICE_PRINTER_NOT_EXIST]= "<span style='background-color=red;'>Drucker konnte nicht gefunden werden!</span>"
textValue[TextKey.PRINT_SERVICE_EMPTY_INK]="<span style='background-color=red;'>Farbe ist alle!</span>"
textValue[TextKey.PRINT_SERVICE_EMPTY_PAPER]="<span style='background-color=red;'>Kein Papier mehr vorhanden!</span>"
textValue[TextKey.PRINT_SERVICE_MISSING_PAPER_CONTAINER]="<span style='background-color=red;'>Der Papierbehälter ist nicht eingesteckt!</span>"
